...
fileOutName is the name (with path) of the output fits file (default is ran.fits).
...
See documentation for masks [here](http://hsca.ipmu.jp/hscsphinx_test/pipeline_tools.html#masks)
